define({ "api": [
  ...
  {
    "type": "post",
    "url": "/admin/fetchAllSchedule",
    "title": "Fetch All Schedule in Institute",
    "name": "Fetch_All_Schedule_in_Institute",
    "group": "Admin",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "get",
    "url": "/admin/defaultHolidays",
    "title": "Fetch Default Holidays",
    "name": "Fetch_Default_Holidays",
    "group": "Admin",
    "version": "0.0.0",
    "filename": "src/routes/admin.js",
    "groupTitle": "Admin"
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "holidays",
            "description": "<p>List of Holiday Objects</p>"
          }
        ]
      }
    },
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "topic",
            "description": "<p>Notification Topic</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  },
  {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "usedID",
            "description": "<p>User Id of Admin</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "mediaUrl",
            "description": "<p>Media URL of the Task</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
    ...
    "version": "0.0.0",
    "filename": "src/routes/task.js",
    "groupTitle": "Task"
  },
  {
    "type": "post",
    "url": "/task/employeeCreate",
    "title": "Employee Create Task",
    "name": "Employee_Create_Task",
    "group": "Task",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "usedID",
            "description": "<p>User Id of Employee</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  },
  {
    "type": "post",
    "url": "/task/createdBy",
    "title": "Get Tasks of GD Combination",
    "name": "Get_Tasks_by_UserID",
    "group": "Task",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  },
  {
    ...
    "url": "/task/fetch",
    "title": "Get Tasks of GD Combination",
    "name": "Get_Tasks_of_GD_Combination",
    "group": "Task",
    "parameter": {
      "fields": {
        "Parameter": [
